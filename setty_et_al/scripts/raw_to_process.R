...
for (i in names(rep_list)) {
  ...
  # Plots
  png(paste0(prefixOut, i, "_Raw_VlnPlot_nFeature_RNA.png"), width = 800, height = 800)
  ...
  png(paste0(prefixOut, i, "_Raw_VlnPlot_nCount_RNA.png"), width = 800, height = 800)
  ...
  png(paste0(prefixOut, i, "_Raw_VlnPlot_percent.mt.png"), width = 800, height = 800)
  ...
  png(paste0(prefixOut, i, "_Raw_FeatureScatter_percent.mt.png"), width = 800, height = 800)
  p <- FeatureScatter(sob.raw, feature1 = "nCount_RNA", feature2 = "percent.mt") +
    theme(
      title = element_text(size = 30), axis.text = element_text(size = 25),
      legend.position = "none"
    ) + geom_smooth(method = "lm", formula = "y~x")
  print(p)
  dev.off()

  png(paste0(prefixOut, i, "_Raw_FeatureScatter_nFeature_RNA.png"), width = 800, height = 800)
  ...
  # Plots
  png(paste0(prefixOut, i, "_Sub_VlnPlot_nFeature_RNA.png"), width = 800, height = 800)
  ...
  png(paste0(prefixOut, i, "_Sub_VlnPlot_nCount_RNA.png"), width = 800, height = 800)
  ...
  png(paste0(prefixOut, i, "_Sub_VlnPlot_percent.mt.png"), width = 800, height = 800)
  ...
  png(paste0(prefixOut, i, "_Sub_FeatureScatter_percent.mt.png"), width = 800, height = 800)
  ...
  png(paste0(prefixOut, i, "_Sub_FeatureScatter_nFeature_RNA.png"), width = 800, height = 800)
  ...
  # Basic PCA
  png(paste0(prefixOut, i, "_basic_PCA.png"), width = 800, height = 800)
  ...
  # Save The plot
  png(paste0(prefixOut, i, "_CCG_PCA.png"), width = 800, height = 800)
  p <- DimPlot(sob.cc)
  print(p)
  dev.off()
  ...
  # Save The plot
  png(paste0(prefixOut, i, "_CCC_PCA.png"), width = 800, height = 800)
  p <- DimPlot(sob.cc)
  print(p)
  dev.off()
  ...
  png(paste0(prefixOut, i, "_C_UMAP.png"), width = 800, height = 800)
