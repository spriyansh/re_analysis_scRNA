...
ggsave(p, filename = paste0(prefixOut, "/Unintegrated/Donor.png"),
...
p <- plot_cells(cds_temp, reduction_method = "UMAP", cell_size = 0.5,
    ...
    guides(colour = guide_legend(override.aes = list(size = rel(6))))
dir.create(paste0(prefixOut, "/Unintegrated/"), showWarnings = FALSE)
ggsave(p, filename = paste0(prefixOut, "/Unintegrated/Sex.png"),
       dpi = 1300, limitsize = FALSE
)
...
p <- plot_cells(cds_temp, reduction_method = "UMAP", cell_size = 0.5,
    ...
    guides(colour = guide_legend(override.aes = list(size = rel(6))))
dir.create(paste0(prefixOut, "/Unintegrated/"), showWarnings = FALSE)
ggsave(p, filename = paste0(prefixOut, "/Unintegrated/Age.png"),
       dpi = 1300, limitsize = FALSE
)
...
p <- plot_cells(cds, reduction_method = "UMAP", cell_size = 0.5,
    ...
    guides(colour = guide_legend(override.aes = list(size = rel(6))))
dir.create(paste0(prefixOut, "/Integrated/"), showWarnings = FALSE)
ggsave(p, filename = paste0(prefixOut, "/Integrated/Sex.png"),
       dpi = 1300, limitsize = FALSE
)
...
p <- plot_cells(cds, reduction_method = "UMAP", cell_size = 0.5,
    ...
    guides(colour = guide_legend(override.aes = list(size = rel(6))))
dir.create(paste0(prefixOut, "/Integrated/"), showWarnings = FALSE)
ggsave(p, filename = paste0(prefixOut, "/Integrated/Age.png"),
       dpi = 1300, limitsize = FALSE
)
...
p <- plot_cells(cds,
    ...
    guides(colour = guide_legend(override.aes = list(size = rel(6))))
dir.create(paste0(prefixOut, "/Integrated/"), showWarnings = FALSE)
ggsave(p, filename = paste0(prefixOut,  "/Integrated/Cluster.png"),
       dpi = 1300, limitsize = FALSE
)
...
# Plotting Monocle3 UMAP
p1 <- plot_cells(cds, reduction_method = "UMAP", cell_size = 0.5,
                 color_cells_by = "cell.type", label_cell_groups = F
) +
    scale_color_brewer(palette = "Dark2") +
    ggtitle("Integrated Data") +
    ...
    guides(colour = guide_legend(override.aes = list(size = rel(6))))
dir.create(paste0(prefixOut, "/Integrated/"), showWarnings = FALSE)
ggsave(p1, filename = paste0(prefixOut, "/Integrated/TrLine.png"),
       dpi = 1300, limitsize = FALSE
)
...
p2 <- plot_cells(cds,
    ...
    theme(plot.margin = margin(0.2,0.2,0,0, "cm"),
          ...
          legend.key.size = unit(0.5, "cm"), plot.title = element_text(size = rel(1))) 
dir.create(paste0(prefixOut, "/Integrated/"), showWarnings = FALSE)
ggsave(p2, filename = paste0(prefixOut, "/Integrated/Pseudotime.png"),
       dpi = 1300, limitsize = FALSE
)

p <- p1+p2 
ggsave(p, filename = paste0(prefixOut, "/Integrated/PseudotimeCombined.png"),
