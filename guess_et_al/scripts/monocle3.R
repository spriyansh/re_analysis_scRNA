...
for (i in names(rep_list)) {
  ...
  ggsave(p,
    filename = paste0(prefixOut, "/Cluster/", i, "_Cluster.png"),
  ...
  ggsave(p1,
    filename = paste0(prefixOut, "/TrajectoryLine/", i, "_TrLine.png"),
    dpi = 1300, limitsize = FALSE
  )
  ...
  ggsave(p2,
    filename = paste0(prefixOut, "/Pseudotime/", i, "_Pseudotime.png"),
    dpi = 1300, limitsize = FALSE
  )

  p <- p1 + p2
  ggsave(p,
    filename = paste0(prefixOut, "/Pseudotime/", i, "_PseudotimeCombined.png"),
